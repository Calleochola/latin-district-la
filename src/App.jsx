...
const FALLBACK_VENUES = [
  ...
  { venue_name: 'West Eight',            tag: 'Nightclub · DJ Sets',          active: 'yes', description: 'Modern nightclub under Hotel Bristol with immersive lights, sound, and late-night energy.',                              address: '425 W 8th St, Los Angeles, CA 90014',               hours_summary: 'Event-based; doors often 10PM',                               instagram: '@west8la',             photo_url: 'https://static.spotapps.co/website_images/ab_websites/287232_website/about_pg_left_new.jpg' },
